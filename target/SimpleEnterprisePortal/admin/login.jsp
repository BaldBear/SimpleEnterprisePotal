...
<%@ page import="com.erving.util.*"%>
<%
	String path = request.getContextPath();
	String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path;
	String adminPath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/admin/";
%>
		...
		<div class="am-g">
			<div class="am-u-lg-6 am-u-md-8 am-u-sm-centered">
				<form action="login.jsp" method="post" class="am-form login-form" onSubmit="return LoginCheck()">
					<%--@declare id="name"--%><%--@declare id="ps"--%><label for="name">
						用户名:
					</label>
					<!-- 文本输入框  用于输入用户名 -->
